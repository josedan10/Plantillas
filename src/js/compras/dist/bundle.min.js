...
var _moduloDeCompras = __webpack_require__(27);

var _moduloDeCompras2 = _interopRequireDefault(_moduloDeCompras);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_moduloDeCompras2.default, null), document.getElementById('app'));
...
var ModuloCompra = function (_React$Component) {
	_inherits(ModuloCompra, _React$Component);

	function ModuloCompra() {
		_classCallCheck(this, ModuloCompra);

		return _possibleConstructorReturn(this, (ModuloCompra.__proto__ || Object.getPrototypeOf(ModuloCompra)).apply(this, arguments));
	}

	_createClass(ModuloCompra, [{
		key: 'super',
		...
		value: function render() {
			...
			var imagenesDeMuestra = _react2.default.createElement(
				'div',
				{ className: 'img-muestras' },
				_react2.default.createElement('img', { src: 'http://conceptodefinicion.de/wp-content/uploads/2015/01/libro.jpg' }),
				_react2.default.createElement('img', { src: 'http://significadosdelossuenos.net/wp-content/uploads/2016/11/So%C3%B1ar-con-libros.png' })
			);

			//Imagen de muestra principal en el objeto de compra

			var imagenPpal = _react2.default.createElement(
				'div',
				{ className: 'img-ppal' },
				_react2.default.createElement('img', { src: 'http://conceptodefinicion.de/wp-content/uploads/2015/01/libro.jpg' })
			);
			...
			var detallesDelProducto = _react2.default.createElement(
				'div',
				{ className: 'detalles-producto' },
				...
				'Cantidad ',
				_react2.default.createElement('input', { id: 'cantidad-producto', type: 'number', name: 'cantidad', min: '1', max: '10', defaultValue: '1' })
			)
			...
			return _react2.default.createElement(
				'div',
				{ id: 'moduloCompra', className: 'grid' },
				imagenesDeMuestra,
				imagenPpal,
				detallesDelProducto,
				_react2.default.createElement(BtnAgregarAlCarrito, null)
			);
		}
	}]);
...
exports.default = ModuloCompra;

var BtnAgregarAlCarrito = function (_React$Component2) {
	_inherits(BtnAgregarAlCarrito, _React$Component2);

	function BtnAgregarAlCarrito() {
		_classCallCheck(this, BtnAgregarAlCarrito);

		return _possibleConstructorReturn(this, (BtnAgregarAlCarrito.__proto__ || Object.getPrototypeOf(BtnAgregarAlCarrito)).apply(this, arguments));
	}

	_createClass(BtnAgregarAlCarrito, [{
		key: 'super',
		value: function _super(props) {
			this.props = props;
...
function OrdenDeCompra(nombre, talla, color, cantidad) {
	_classCallCheck(this, OrdenDeCompra);
